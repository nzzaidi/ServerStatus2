# ServerStatus中文版-vnstat

看到有人需要，同时好像自己也有这个需求，参考 [https://github.com/P3TERX/ServerStatus-V](https://github.com/P3TERX/ServerStatus-V) 中 vnstat 统计流量的实现方式，在 [https://github.com/cppla/ServerStatus](https://github.com/cppla/ServerStatus) 的基础上，优化和更新此功能。
